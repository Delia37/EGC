...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["bunny"], glm::vec3(0.5f, -0.5f, 0), glm::vec3(0.02f));
    RenderMesh(meshes["sphere"], glm::vec3(-0.5f, 0.5f, -1));

    std::string meshNames[] = { "box", "teapot", "sphere" };
    RenderMesh(meshes[meshNames[currentMeshIndex]], glm::vec3(x, y, z));
...
void Lab1::OnKeyPress(int key, int mods)
{
    ...
    if (key == GLFW_KEY_G) {
        currentMeshIndex = (currentMeshIndex + 1) % 3;
    }
