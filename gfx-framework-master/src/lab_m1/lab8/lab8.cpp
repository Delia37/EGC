...
void Lab8::Init()
{
    ...
    {
        secondLightPosition = glm::vec3(-2, 1, -2);
...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(1.0, 0.0, 1.0));
...

    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(1.0, 1.0, 0.0));
    ...
    // Render ground
    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0.25, 0.25, 0.25));
...
void Lab8::RenderSimpleMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix, const glm::vec3& color)
{
    ...
    int light_cutoff = glGetUniformLocation(shader->program, "cut_off_angle");
    glUniform1f(light_cutoff, cutoffAngle);

    int light_type = glGetUniformLocation(shader->program, "type_of_light");
